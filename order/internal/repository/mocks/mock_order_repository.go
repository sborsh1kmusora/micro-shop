...
// Update provides a mock function with given fields: ctx, uuid, orderUpdate
func (_m *OrderRepository) Update(ctx context.Context, uuid string, orderUpdate *model.OrderUpdate) error {
	ret := _m.Called(ctx, uuid, orderUpdate)
...
func (_e *OrderRepository_Expecter) Update(ctx interface{}, uuid interface{}, orderUpdate interface{}) *OrderRepository_Update_Call {
	return &OrderRepository_Update_Call{Call: _e.mock.On("Update", ctx, uuid, orderUpdate)}
}

func (_c *OrderRepository_Update_Call) Run(run func(ctx context.Context, uuid string, orderUpdate *model.OrderUpdate)) *OrderRepository_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
